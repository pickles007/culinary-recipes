				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 home-about-left">
							<h1>Наша історія</h1>
							<p>
								З початку четвертого курсу нам дали завдання розробити спільний проект командою у складі 5 чоловік. Кожен з нас мав своє завдання та виконував певну роль у команді. Результат нашої плідної спільної праці ви можете спостерігати на екрані.
							</p>
						</div>
					...
					<div class="row">
						<div class="active-review-carusel">
							<div class="single-review">
								...
								<p>
									“У нашому блозі ви можете знайти багато корисної інформації щодо приготування різних страв.”
								</p>
							</div>
							<div class="single-review">
								...
								<p>
									“Ви можете додавати та ділитись власними рецептами. Шукати рецепти за їхніми категоріями.”
								</p>
							</div>
							<div class="single-review">
								...
								<p>
									“Завдяки нашому блогу ви зможете приготувати ті страви, які сподобаються всім вашим членам сім'ї.”
								</p>
							</div>
						</div>
					</div>
