        ...
        <div class="row">
            ...
            <?php
                    while(($row = $allnews->fetch_assoc())!=false){
                        ...
                        echo "<button type='submit' value='".$row["id"]."' name='delete'><h4 style='font-size:14px;color:red;'>Видалити</h4></button>";
                        echo "</form>";
                        echo "<form method='get'>";
                        echo "<input name='idRecipe' type='text' value='".$row["id"]."' style='display:none;'>";
                        echo "<button type='submit' value='editRecipe' name='action'><h4 style='color:#8FA000; font-size:14px;'>Редагувати</h4></button>";
                        echo "</form>";
